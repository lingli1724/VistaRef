...
echo "train_rec_egopoint_single_dataset_finetuning_large.sh"
...
# you provided this ckpt; keep as-is
FINETUNE_INIT=/path/to/rec_mrefm_pretrain_large_patch16_384.pth
SENTENCEPIECE_MODEL=/path/to/beit3.spm


####### warmup (official hyperparams)
...
## finetuning training (official hyperparams)
python train_VistaRef.py \
  --epochs 30 \
  --batch_size 8 \
  --lr 0.00003 \
...
# eval (official pattern: eval val + test)
